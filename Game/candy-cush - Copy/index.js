document.addEventListener("DOMContentLoaded", () => {
  ...
  function checkRowForThree() {
    for (i = 0; i < 61; i++) {
      ...
      let declaredColor = squares[i].style.backgroundImage;
      const isBank = squares[i].style.backgroundImage === "";
      ...
      if (
        rowOfThree.every(
          (index) =>
            squares[index].style.backgroundImage === declaredColor && !isBank
        )
      ) {
        score += 3; scoreDisplay.innerHTML=score
